<template>
  <div class="login-page">
    ...
    <div class="login-container">
      <v-card class="login-card mx-auto pa-8" max-width="450" elevation="8">
        <v-img
          src="/logo.png" 
          height="80"
          contain
        ...
        ></v-img>
        <v-card-title class="text-h4 font-weight-bold text-center mb-6">Welcome Back</v-card-title>
        ...
        <div class="text-center mt-6">
          <router-link to="/register" class="register-link">
            Don't have an account? <span class="font-weight-bold">Register</span>
          </router-link>
        </div>
